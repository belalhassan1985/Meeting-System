    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">لوحة التحكم الإدارية</h1>
          <p className="text-sm sm:text-base text-gray-600">إدارة المستخدمين والغرف والنظام</p>
        </div>
